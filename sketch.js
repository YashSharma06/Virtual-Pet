...
function preload()
{
  ...
  dogbed = loadImage("Bed Room.png");
  washdog = loadImage("Wash Room.png");
  gerdendog = loadImage("Garden.png");
  saddogy = loadImage("Lazy.png");
}
